...
public final class WholeProjectAnalyzerFacade {
    ...
    @NotNull
    public static ResolveSessionResult getLazyResolveResultForFile(@NotNull JetFile file) {
    ...
    public static BindingContext getContextForElement(@NotNull JetElement jetElement) {
        ResolveSessionResult resolveSessionResult = getLazyResolveResultForFile((JetFile) jetElement.getContainingFile());
        return resolveSessionResult.resolveToElement(jetElement);
    }
}
