...
public class ResolveSessionResult implements KotlinCodeAnalyzer, ModificationTracker {
    private final JetFile file;
    private final ResolveSession resolveSession;
    private final AtomicLong canceledTracker = new AtomicLong();

    public ResolveSessionResult(JetFile file, ResolveSession resolveSession) {
        this.file = file;
