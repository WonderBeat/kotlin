...
public class JetFunctionParameterInfoHandler implements ParameterInfoHandlerWithTabActionSupport<
        ...
        Pair<? extends FunctionDescriptor, ResolveSessionResult>,
        JetValueArgument>
{
    ...
    @Nullable
    @Override
    public Object[] getParametersForDocumentation(Pair<? extends FunctionDescriptor, ResolveSessionResult> p, ParameterInfoContext context) {
        return ArrayUtil.EMPTY_OBJECT_ARRAY; //todo: ?
    }
    ...
    @Override
    public void updateUI(Pair<? extends FunctionDescriptor, ResolveSessionResult> itemToShow, ParameterInfoUIContext context) {
        ...
        ResolveSessionResult sessionResult = itemToShow.second;
        ...
        BindingContext bindingContext = sessionResult.resolveToElement((JetElement) owner);
    ...
    private static JetValueArgumentList findCall(CreateParameterInfoContext context) {
        ...
        BindingContext bindingContext = sessionResult.resolveToElement(callNameExpression);
        ...
        Collection<Pair<? extends DeclarationDescriptor, ResolveSessionResult>> itemsToShow = new ArrayList<Pair<? extends DeclarationDescriptor, ResolveSessionResult>>();
        for (DeclarationDescriptor variant : variants) {
            if (variant instanceof FunctionDescriptor) {
                ...
                if (functionDescriptor.getName().equals(refName)) {
                    ...
                    itemsToShow.add(Pair.create(functionDescriptor, sessionResult));
                }
            }
                ...
                if (classDescriptor.getName().equals(refName)) {
                    ...
                    for (ConstructorDescriptor constructorDescriptor : classDescriptor.getConstructors()) {
                        ...
                        itemsToShow.add(Pair.create(constructorDescriptor, sessionResult));
                    }
                }
            }
        }
